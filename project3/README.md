...
5. This one was kind of just me having fun and getting creative but it has its uses. Through the web interface, it gives users a convenient way to access and view information without having to keep their files or open them.
...
## Background on why I choose this project
I wanted to keep working with node I will say that this is the area I liked working on the most. When I first read the node website that I linked below I liked it a lot plus it was easier for me to follow. There were so many different things to try and look up and since I worked with node on my second project I wanted to follow up on that. While staring at it I thought about how I could make it better and complex enough to get a good grade. So I did a lot of research and came across a couple of things but the one that stuck out the most was the Nmap scan. I wanted to implement that so I kept looking for things to help me code it and I was able to figure it out. Took me a while because I needed to gather the IP address from a user's machine instead of having them input it which was another route I could have chosen but I wanted it to be automatic. I then took some inspiration from the lab where we had to connect to the web from the local host and I also wanted to implement that as well. This was more of me seeing how far I could take it but the learning process for it was fun. I learned a lot from the GitHub url from the class but to allow it to display the files created was something I had to learn as well. For the retry mechanism, I thought I should include that since the professor said he was going to put our code through the wringer and I think that it'll hold up pretty well. And I still felt like that wasn't enough and I felt more could be extracted from a machines system that users would need like to know, those being CPU temperature and usage and disk information than I thought I would put in the network interfaces as well because I hate having to go through apps and settings to find it.
